...
{
    struct _jt606_send_zeroAdj_field
    {
        char head;//'@'
...
union _jt606_reply_zeroAdj
{
    ...
    //char frame[];
    char frame[sizeof(struct _jt606_reply_zeroAdj_field)];
};
...
{
    struct _jt606_send_fullrangeAdj_field
    {
        char head;
        char sensor_id[2];
        char cmd;
...
union _jt606_reply_fullrangeAdj
{
    ...
    //char frame[];
    char frame[sizeof(struct _jt606_reply_fullrangeAdj_field)];
};
...
{
    struct _jt606_send_readFuelLevel_field
    {
        char head;
        char sensor_id[2];
        char cmd;
...
union _jt606_reply_readFuelLevel
{
    ...
    char frame[sizeof(struct _jt606_reply_readFuelLevel_field)];
};
...
static inline void jt606_cmd_send(char *frame, uint8_t frame_length)
{
    ...
    sysPrint_serialPrint_P(PSTR("sending cmd: "));
    ...
    sysPrint_serialPrintln_P(PSTR("sending cmd: finish"));
#endif // JT606_CMD_SEND_DEBUG_PRINT
}
...
static int8_t send_and_reply(char *sendframe, char *replyframe)//sequential
{
    ...
    {
        #ifdef SEND_AND_REPLY_DEBUG_PRINT
        sysPrint_serialPrintln_P(PSTR("Serial received buffer is: "));
        #endif // SEND_AND_REPLY_DEBUG_PRINT
...
#define JT606_CMD_READ_ZERO_ADJ     '@','0','1','B','0','1','0','X','X','#'//@01B01034#
    ...
    sysPrint_serialPrintln_P(PSTR("[CFLS JT606X]"));
    ...
    //(cod_ret==1)? sysPrint_serialPrintln_P(PSTR("OK")):sysPrint_serialPrintln_P(PSTR("ERROR"));
    #endif // JT606_SEND_ZEROADJ_DEBUG_PRINT
...
//    pinMode(RS485_DIR, OUTPUT);
    ...
    {
        sysPrint_serialPrintln("");
        sysPrint_lcd_serialPrintln_P(0,LCDAN_STR_FORMAT_ALIGN_CENTER,PSTR("FUEL SENSOR"));
        sysPrint_lcd_serialPrintln_P(1,LCDAN_STR_FORMAT_ALIGN_CENTER,PSTR("Please wait while"));
        sysPrint_lcd_serialPrintln_P(2,LCDAN_STR_FORMAT_ALIGN_CENTER,PSTR("fuel sensor is"));
        sysPrint_lcd_serialPrintln_P(3,LCDAN_STR_FORMAT_ALIGN_CENTER,PSTR("self checking..."));
    }
