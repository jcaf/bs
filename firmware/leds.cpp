...
*/
 ...
 {
     out_leds[0] = ReadPin(PORTRxLED1, PINxLED1);
     out_leds[1] = ReadPin(PORTRxLED2, PINxLED2);
     out_leds[2] = ReadPin(PORTRxLED3, PINxLED3);
     out_leds[3] = ReadPin(PORTRxLED4, PINxLED4);
     out_leds[4] = ReadPin(PORTRxLED5, PINxLED5);
     out_leds[5] = ReadPin(PORTRxLED6, PINxLED6);
// 	out_leds_read();
 }
