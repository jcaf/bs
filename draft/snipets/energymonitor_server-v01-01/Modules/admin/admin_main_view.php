...
<table class="table table-striped ">
    <tr>
        <td colspan="2">Remote Sensing Monitor version: <?php echo $emoncms_version; ?></td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            ...
            <p><?php echo _('Run this after updating this software, after installing a new module or to check the database status.'); ?></p>
        </td>
        <td>
