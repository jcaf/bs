...
<div style="margin: 0px auto; max-width:392px; padding:10px;">
    <div style="max-width:392px; margin-right:20px; padding-top:45px; padding-bottom:15px; color: #888;">
        <img style="margin:12px;" src="<?php echo $path; ?>Theme/quantico_automatizacion.jpg" alt="Quantico" width="256" height="46" />
        <!--<img style="margin:12px;" src="<?php echo $path; ?>Theme/emoncms_logo.png" alt="Quantico" width="256" height="46" />-->
    </div>
