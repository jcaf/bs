...
{
    char buf[15];
    String db_mFuelSensor_irrTank_spTable_units[2];
    ...
    if (thismenu_sm0 == 0)//only at enter
    {
        ...
        vscroll.init(db_mFuelSensor_irrTank_spTable_units, 2, dispShowBuff, 2, FEAT_MARK_ON, vscroll.base, vscroll.offset);
        //
        lcd.clear();
...
void mFuelSensor_irrTank_spTable_units_lengthUnits_job(void)
{
    ...
    String db_mFuelSensor_irrTank_spTable_units_lengthUnits[MENU_FUELSENSOR_LENGTHUNITS_NUMITEM];
    ...
    if (thismenu_sm0 == 0)
    {
        ...
        vscroll.init(db_mFuelSensor_irrTank_spTable_units_lengthUnits, MENU_FUELSENSOR_LENGTHUNITS_NUMITEM, dispShowBuff, 1, FEAT_MARK_ON);
...
void mFuelSensor_irrTank_spTable_units_volumenUnits_job(void)
{
    ...
    String db_mFuelSensor_irrTank_spTable_units_volumenUnits[MENU_FUELSENSOR_VOLUMEUNITS_NUMITEM];
    ...
    if (thismenu_sm0 == 0)
    {
        ...
        //
        vscroll.init(db_mFuelSensor_irrTank_spTable_units_volumenUnits, MENU_FUELSENSOR_VOLUMEUNITS_NUMITEM, dispShowBuff, 2, FEAT_MARK_ON);
        //
        lcd.clear();
